...
# def pre_save_create_easypost_shipment(sender, instance, *args, **kwargs):
    # valid = False
    # if instance.shipmentFromAddress and instance.shipmentToAddress:
        # # check parcel is good
        # if instance.parcel_set.count() > 0:

            # print('ther is a parcel')
            # for parcel in instance.parcel_set.all():
                # if parcel.parcelName and parcel.parcelWeight > 0:
                    # print('everything is there')
                    # valid = True

# pre_save.connect(pre_save_create_easypost_shipment, sender=Shipment)
